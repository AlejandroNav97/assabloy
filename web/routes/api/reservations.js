...
// POST"/http://ec2-3-16-50-213.us-east-2.compute.amazonaws.com/assaservice/api/check-in" - process.env.COGNITO_SERVER
router.post('/cognito-checkin', reservationController.cognitoCheckin);
